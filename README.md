...
-To identify or query each record easily and efficiently.
...
-An intermediary table is needed in between the two tables having a one to many relationship with both.
